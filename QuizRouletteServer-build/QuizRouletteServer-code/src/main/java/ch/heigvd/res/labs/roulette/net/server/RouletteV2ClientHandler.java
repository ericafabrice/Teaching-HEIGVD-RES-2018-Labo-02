        ...
        while (!done && ((command = reader.readLine()) != null)) {
            ...
            switch (command.toUpperCase()) {  
                ...
                case RouletteV2Protocol.CMD_LOAD:
                    ...
                    numberOfStudents = store.getNumberOfStudents() - nbStudents;                       
                    writer.println(JsonObjectMapper.toJson(new LoadCommandResponse(RouletteV2Protocol.A_SUCCESS, nbStudents)));                    
                    writer.flush();
                    break;
                    
                case RouletteV2Protocol.CMD_BYE:
                    done = true;
                    writer.println(JsonObjectMapper.toJson(new ByeCommandResponse(RouletteV2Protocol.A_SUCCESS, nbCmd)));
                    writer.flush();
                    break;
